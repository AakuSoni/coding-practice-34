  ...
  const renderRatingsFiltersList = () => {
    ...
    return ratingsList.map(rating => {
      ...
      const ratingClassName = 
        activeRatingId === rating.ratingId ? `and-up active-rating` : `and-up active-rating`
      return (
  ...
  const renderSearchInput = () => {
    ...
    return (
      <div className="search-input-container">
       <input value={searchInput} type="search" className="search-input" placeholder="Search" onChange={onChangeSearchInput} onKeyDown = {onEnterSearchInput}/>
